    ...
    public class NumeroVillaController : ControllerBase
    {
        ...
        public async Task<ActionResult<APIResponse>> GetNumeroVilla(int id)
        {
            try
            {
                ...
                var nuemroVilla = await _numeroRepo.Obtener(v => v.VillaNo == id);
                ...
                _response.Resultado = _mapper.Map<NumeroVillaDto>(nuemroVilla);
                _response.statusCode = HttpStatusCode.OK;
                return Ok(_response);
            }
            catch (Exception ex)
        ...
        public async Task<ActionResult<APIResponse>> CrearNumeroVilla([FromBody] NumeroVillaCreateDto createDto)
        {
            try
            {
                ...
                //personalizar con ModelState
                if (await _numeroRepo.Obtener(v => v.VillaNo == createDto.VillaNo) != null)
                {
                    ModelState.AddModelError("NombreYaExiste", "El numero de La Villa ya existe");
                    return BadRequest(ModelState);
                }
        ...
        public async Task<IActionResult> UpdateNumeroVilla(int id,[FromBody] NumeroVillaUpdateDto updateDto)
        {
            ...
            {
                ModelState.AddModelError("ClaveForanea", "El id de la villa es invalido!");
                return BadRequest(ModelState);
            }
